...
{
    class culebritaconColaconLista
    {
        ...
        public void principal()
        {
            ...
            var culebrita = new ColaConLista();//sustituir
            ...
            culebrita.insertar(posiciónActual);//sustituir
            ...
            int longitudCulebra, Size screenSize)
        {
            ...
            if (culebra.choque((posiciónObjetivo))) return false;//sustituir
